...
export default function Product({ id, image_url, name, price }: ProductType) {
  return (
    <div className="w-48 h-48 px-2 flex flex-col justify-center items-center rounded-sm bg-primary-strong mx-auto border-4 border-primary-strong hover:bg-primary-strong/50 duration-200 cursor-pointer">
