...
export default function Main({produto}:{produto: ProductType}) {
 return (
   <div className="py-2 px-4 min-h-section w-full bg-primary-strong selection:bg-secondary-strong/15 flex justify-center items-center gap-x-28 max-lg:gap-x-10 max-[850px]:flex-col max-md:py-8 max-md:px-8 rounded">
