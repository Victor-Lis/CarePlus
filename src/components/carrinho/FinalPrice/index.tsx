...
export default function FinalPrice() {
  ...
  return (
    <div className="w-full py-5 px-6 bg-tertiary/65 flex justify-between items-center gap-y-5 rounded-bl rounded-br border-x-4 border-b-4 border-primary-strong">
