...
export default function Footer({type}:{type?: "primary" | "primary-strong" | "secondary"}) {
 return (
   <footer className={`w-full rounded-tl rounded-tr flex flex-wrap justify-around items-center gap-y-2 min-h-12 py-4 px-16 max-md:px-8 max-sm:px-2 ${type === "secondary" ? "bg-primary" : type === "primary-strong" ? "bg-primary-strong" : "bg-tertiary/75"}`}>
